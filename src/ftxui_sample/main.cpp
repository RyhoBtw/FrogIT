...
// configuration step. It creates a namespace called `FrogIT`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", FrogIT::cmake::project_name, FrogIT::cmake::project_version) };
